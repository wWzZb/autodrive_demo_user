...
data = {'Simdata':
        ...
        'VehicleControl': {'throttle': 0.0, 'brake': 0.0, 'steering': 0.0, 'handbrake': False,
                           'isManualGear': False, 'gear': 3, "movetostart": 0, "movetoend": 0},
        'Trajectory': {
            'trajectorySize': 20,
            'trajectory':
        ...
        'ObstacleEntryList': [
            {'id': -344300, 'viewId': -344300, 'type': 6, 'posX': -1.88, 'posY': -60.0, 'posZ': 0.0, 'oriX': 0.0,
             ...
             'height': 1.53, 'RedundantValue': "SpeedLimit|30"}],  # RedundantValue: 冗余位， 包括限速情况
        ...
        "MapInfo": { # 高精地图存储信息
                    "path": "D:/project/zhongwei/SimCar-20240514/Assets/StreamingAssets/mapfile",
                    "route": "route",
                    "tpoints": "tpoint",
                    "TileDataList": [{
                        "name": "StraightRoad",
...
class RoadLine:
    ...
    def __trajListInput(self, RoadLineData):
        self.RoadLineLen = len(RoadLineData)
